...
public class DataUtil {
    ...
    public static List<VideoBean> getDouYinVideoList() {
        ...
        videoList.add(new VideoBean("fire",
                "http://p9.pstatp.com/large/4c87000639ab0f21c285.jpeg",
                "https://aweme.snssdk.com/aweme/v1/play/?video_id=v0200fa50000br1pigk81uko1dlqe5ag&media_type=4&vr_type=0&ratio=720p&line=0"));
        videoList.add(new VideoBean("little girl 1",
        ...
        videoList.add(new VideoBean("little girl 2",
        ...
        videoList.add(new VideoBean("little girl 3",
        ...
        videoList.add(new VideoBean("little girl 4",
        ...
        videoList.add(new VideoBean("little girl 5",
                "http://p9.pstatp.com/large/4c87000639ab0f21c285.jpeg",
